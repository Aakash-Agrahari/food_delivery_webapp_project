...
public class FoodServiceImpl implements FoodService{
    ...
    public FoodResponse readFood(String id) {
        FoodEntity exsitingFood = foodRepository.findById(id).orElseThrow(() -> new RuntimeException("Food can not be found for the id"+id));
        return convertToResponse(exsitingFood);
    }
